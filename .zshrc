...
source ~/.zsh/dracula-syntax/zsh-syntax-highlighting.sh
...
alias get-lecture='/usr/local/bin/yt-dlp --cookies-from-browser chrome -P "~/Documents/Accounting/Semester_1/Lectures" -f "bestvideo[height<=1080][ext=mp4]+bestaudio[ext=m4a]/best[ext=mp4]/best" --no-mtime --no-cache-dir'
# Visual Flex Aliases
alias matrix="cmatrix -C magenta"
alias clock="TZ='Africa/Johannesburg' tty-clock -c -C 5 -b -B -s"

# Environment variables for your KDE/i3 setup
export KDEWM="/usr/bin/i3"
export PATH="$HOME/.local/bin:$HOME/.cargo/bin:$PATH"

# Run neofetch automatically when opening a new terminal
neofetch
